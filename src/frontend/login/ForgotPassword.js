...
export default function () {
    ...
    const sendEmail = async (e) => {
            if (formValues.user_email.includes('@') == false || formValues.user_email.includes('.') == false) {
    ...
    const handleSubmit = async (event) => {
        ...
        const data = { user_password : formValues.user_password };
        const res = await axios.put(`http://localhost:3000/sign/${formValues._id}`, data);
        history.push('/signin')
    };
        ...
        <>
            ...
            <div className='mainsignup'>
                ...
                {error ? (
                    ...
                    <div className='mysiginhead'><h3>Forgot Password</h3> <img className='Rudhram' src={Rudhram} alt="" /></div>
                    {pass ? (
                    ...
                    {(switchnext === 0) ? (
                        ...
                        <>
                    <h3 className='myheading'>Update Password</h3>
                    <div >
                    ...
                    <div className='mysigninbutton' ><Button id='mybutt' onClick={handleSubmit}>Update</Button></div> 
                    </>  
                    )}  
