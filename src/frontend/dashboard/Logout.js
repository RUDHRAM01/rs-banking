...
export default function PersistentDrawerLeft({ formValue, setFormValue,user,_id,checkLogin,setCheckLogin}) {
      ...
      <Main open={open}>
        <DrawerHeader />
            <Typography paragraph>
              <div className='accountframe23'>
                <p className='mylog'>Are you sure you want to logout?</p>
                <button onClick={() => { window.location = "/"; setCheckLogin(false); }}><AiOutlineLogout className='myiconlog'/></button>
              </div>
